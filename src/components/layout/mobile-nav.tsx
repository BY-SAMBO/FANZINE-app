...
const navigation = [
  { name: "Dashboard", href: "/dashboard", icon: LayoutDashboard, roles: ["administrador", "mesero", "cajero"] },
  { name: "Productos", href: "/productos", icon: Package, roles: ["administrador", "mesero", "cajero"] },
  { name: "Sync Fudo", href: "/sync", icon: RefreshCw, roles: ["administrador"] },
  { name: "Delivery", href: "/delivery", icon: Truck, roles: ["administrador"] },
  { name: "Checklist", href: "/checklist", icon: CheckSquare, roles: ["administrador", "mesero"] },
  { name: "Configuracion", href: "/configuracion", icon: Settings, roles: ["administrador"] },
];
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/40 uppercase">{user?.rol || "—"}</p>
          </div>
        </div>
        <button
          onClick={signOut}
