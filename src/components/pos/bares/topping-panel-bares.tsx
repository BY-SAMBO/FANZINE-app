...
export function ToppingPanelBares() {
  const toppingSelection = useRemotePosStore((s) => s.toppingSelection);
  const toggleTopping = useRemotePosStore((s) => s.toggleTopping);
  const confirmToppings = useRemotePosStore((s) => s.confirmToppings);
  const cancelToppings = useRemotePosStore((s) => s.cancelToppings);
